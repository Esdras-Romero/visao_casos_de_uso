# UC042 - Vincular escalas ao Cartão Programa

## Objetivo
Integrar planejamento estratégico à execução operacional.

## Ator principal
Administrador Operacional

## Pré-condições
- Escala e Cartão Programa existentes.

## Pós-condições
- Vínculo registrado.

## Fluxo principal
1. O ator acessa a funcionalidade **Vincular escalas ao Cartão Programa**.
