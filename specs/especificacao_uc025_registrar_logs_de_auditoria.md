...
## Objetivo
Registrar operações críticas do sistema.

## Ator principal
Administrador do Sistema

## Pré-condições
- Operação crítica executada.

## Pós-condições
- Log gravado com responsável e dados da alteração.

## Fluxo principal
1. O ator acessa a funcionalidade **Registrar logs de auditoria**.
