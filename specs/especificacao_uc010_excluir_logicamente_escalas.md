...
## Objetivo
Inativar escala preservando histórico operacional.
...
## Pós-condições
- Escala marcada como inativa/excluída logicamente.

## Fluxo principal
1. O ator acessa a funcionalidade **Excluir logicamente escalas**.
