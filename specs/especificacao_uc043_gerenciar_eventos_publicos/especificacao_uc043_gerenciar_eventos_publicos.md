# UC043 - Gerenciar eventos públicos

## Objetivo
Cadastrar eventos públicos para planejar efetivo.
...
## Pós-condições
- Evento cadastrado e considerado no planejamento.

## Fluxo principal
1. O ator acessa a funcionalidade **Gerenciar eventos públicos**.
