# UC034 - Consolidar dados dos plantões

## Objetivo
Gerar estatísticas institucionais automaticamente.

## Ator principal
Diretoria Operacional

## Pré-condições
- Relatórios de plantão registrados.

## Pós-condições
- Dados consolidados para indicadores.

## Fluxo principal
1. O ator acessa a funcionalidade **Consolidar dados dos plantões**.
