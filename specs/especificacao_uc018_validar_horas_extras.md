...
## Objetivo
Validar administrativamente horas extras registradas.
...
## Pós-condições
- Hora extra aprovada/reprovada conforme conformidade legal e orçamentária.

## Fluxo principal
1. O ator acessa a funcionalidade **Validar horas extras**.
