...
## Objetivo
Cadastrar servidores da corporação.

## Ator principal
Setor de RH

## Pré-condições
- RH autenticado e dados funcionais válidos.

## Pós-condições
- Servidor cadastrado no sistema.

## Fluxo principal
1. O ator acessa a funcionalidade **Cadastrar servidores**.
