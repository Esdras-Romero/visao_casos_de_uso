# UC026 - Rastrear alterações

## Objetivo
Identificar responsáveis por modificações no sistema.
...
## Pós-condições
- Alterações rastreadas historicamente.

## Fluxo principal
1. O ator acessa a funcionalidade **Rastrear alterações**.
