...
## Objetivo
Criar, alterar e remover permissões associadas aos perfis.
...
## Pós-condições
- Perfis e permissões atualizados e registrados em auditoria.

## Fluxo principal
1. O ator acessa a funcionalidade **Gerenciar perfis e permissões**.
