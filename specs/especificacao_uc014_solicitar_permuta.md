...
## Objetivo
Solicitar troca de plantão com outro servidor.

## Ator principal
Servidor Operacional

## Pré-condições
- Servidor autenticado e plantão existente.

## Pós-condições
- Solicitação de permuta registrada para análise.

## Fluxo principal
1. O ator acessa a funcionalidade **Solicitar permuta**.
