...
## Objetivo
Acessar o sistema com login e senha conforme perfil institucional.
...
## Pós-condições
- Usuário autenticado e redirecionado às funcionalidades permitidas.

## Fluxo principal
1. O ator acessa a funcionalidade **Realizar autenticação**.
