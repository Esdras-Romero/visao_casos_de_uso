...
## Objetivo
Cadastrar usuários vinculados à corporação.

## Ator principal
Administrador do Sistema

## Pré-condições
- Administrador autenticado e servidor existente ou dados válidos.

## Pós-condições
- Usuário cadastrado e apto a receber permissões.

## Fluxo principal
1. O ator acessa a funcionalidade **Cadastrar usuários**.
