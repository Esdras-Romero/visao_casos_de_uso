# UC017 - Registrar horas extras

## Objetivo
Registrar horas extras realizadas pelos servidores.

## Ator principal
Supervisor Operacional

## Pré-condições
- Plantão ou serviço extraordinário existente.

## Pós-condições
- Hora extra registrada para validação.

## Fluxo principal
1. O ator acessa a funcionalidade **Registrar horas extras**.
