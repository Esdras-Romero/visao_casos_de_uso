...
## Objetivo
Solicitar recuperação de senha por e-mail institucional.

## Ator principal
Usuário do Sistema

## Pré-condições
- Usuário possui e-mail institucional cadastrado.

## Pós-condições
- Link ou instrução de recuperação enviado ao e-mail.

## Fluxo principal
1. O ator acessa a funcionalidade **Recuperar senha**.
