...
## Objetivo
Impedir acesso de usuários desligados, afastados ou indevidos.
...
## Pós-condições
- Usuário bloqueado/desativado sem exclusão física do histórico.

## Fluxo principal
1. O ator acessa a funcionalidade **Bloquear ou desativar usuários**.
