...
## Objetivo
Compartilhar e consultar dados funcionais entre sistemas.

## Ator principal
Setor de RH

## Pré-condições
- API ou meio de integração disponível.

## Pós-condições
- Dados integrados de forma consistente.

## Fluxo principal
1. O ator acessa a funcionalidade **Integrar com sistemas de RH**.
