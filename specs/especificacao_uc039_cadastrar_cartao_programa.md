# UC039 - Cadastrar Cartão Programa

## Objetivo
Cadastrar planejamento estratégico das atividades.

## Ator principal
Diretoria Operacional

## Pré-condições
- Diretoria autenticada.

## Pós-condições
- Cartão Programa cadastrado.

## Fluxo principal
1. O ator acessa a funcionalidade **Cadastrar Cartão Programa**.
2. O sistema apresenta os dados e opções necessárias.
3. O ator informa ou seleciona os dados do servidor.
