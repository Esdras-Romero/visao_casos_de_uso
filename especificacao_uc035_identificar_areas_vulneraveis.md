# UC035 - Identificar áreas vulneráveis

## Objetivo
Identificar áreas críticas por indicadores estatísticos.
...
## Pós-condições
- Áreas vulneráveis apresentadas para planejamento.

## Fluxo principal
1. O ator acessa a funcionalidade **Identificar áreas vulneráveis**.
