...
## Objetivo
Validar jornadas de trabalho automaticamente.
...
## Pós-condições
- Conformidade validada e inconsistências sinalizadas.

## Fluxo principal
1. O ator acessa a funcionalidade **Validar conformidade legal**.
