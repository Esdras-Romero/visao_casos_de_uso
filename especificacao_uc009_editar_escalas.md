...
## Objetivo
Alterar escalas previamente cadastradas.

## Ator principal
Supervisor Operacional

## Pré-condições
- Escala existente e ativa.

## Pós-condições
- Escala atualizada e revalidada.

## Fluxo principal
1. O ator acessa a funcionalidade **Editar escalas**.
2. O sistema apresenta os dados e opções necessárias.
3. O ator informa ou seleciona os dados exigidos do guarda.
