...
## Objetivo
Detectar sobreposição de escalas e jornadas ilegais.

## Ator principal
Administrador Operacional

## Pré-condições
- Escala em criação ou alteração.

## Pós-condições
- Sistema bloqueia conflitos e informa inconsistências.

## Fluxo principal
1. O ator acessa a funcionalidade **Validar conflitos de jornadas**.
