# UC033 - Detalhar relatório de plantão

## Objetivo
Registrar equipe, viaturas, áreas, ocorrências e eventos.

## Ator principal
Supervisor Operacional

## Pré-condições
- Relatório de plantão em edição.

## Pós-condições
- Detalhes operacionais consolidados.

## Fluxo principal
1. O ator acessa a funcionalidade **Detalhar relatório de plantão**.
