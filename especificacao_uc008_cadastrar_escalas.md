...
## Objetivo
Cadastrar escalas operacionais e plantões.

## Ator principal
Supervisor Operacional

## Pré-condições
- Supervisor autenticado e servidores disponíveis.

## Pós-condições
- Escala cadastrada sem conflitos.

## Fluxo principal
1. O ator acessa a funcionalidade **Cadastrar escalas**.
2. O sistema apresenta os dados e opções necessárias.
3. O ator informa ou seleciona os dados de escala do guarda.
