# UC044 - Sugerir distribuição estratégica

## Objetivo
Sugerir alocação de efetivo com base em indicadores.
...
## Pós-condições
- Sugestão de distribuição apresentada.

## Fluxo principal
1. O ator acessa a funcionalidade **Sugerir distribuição estratégica**.
