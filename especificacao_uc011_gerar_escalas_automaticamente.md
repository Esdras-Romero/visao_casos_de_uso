...
## Pré-condições
- Regimes configurados e servidores disponíveis.

## Pós-condições
- Escalas geradas automaticamente e validadas.

## Fluxo principal
1. O ator acessa a funcionalidade **Gerar escalas automaticamente**.
