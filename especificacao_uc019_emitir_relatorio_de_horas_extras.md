...
## Objetivo
Emitir relatórios consolidados de horas extras.

## Ator principal
Gestor Administrativo

## Pré-condições
- Existência de registros de horas extras.

## Pós-condições
- Relatório gerado para análise gerencial.

## Fluxo principal
1. O ator acessa a funcionalidade **Emitir relatório de horas extras**.
