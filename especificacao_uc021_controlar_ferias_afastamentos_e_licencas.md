...
## Objetivo
Registrar situações funcionais dos servidores.
...
## Pós-condições
- Situação funcional registrada e considerada nas escalas.

## Fluxo principal
1. O ator acessa a funcionalidade **Controlar férias, afastamentos e licenças**.
