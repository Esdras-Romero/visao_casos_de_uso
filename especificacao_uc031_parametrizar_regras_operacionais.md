...
## Objetivo
Configurar regras, limites, permissões e fluxos.
...
## Pós-condições
- Parâmetros salvos e versionados quando necessário.

## Fluxo principal
1. O ator acessa a funcionalidade **Parametrizar regras operacionais**.
