...
## Objetivo
Registrar autenticações e encerramentos de sessão.

## Ator principal
Administrador do Sistema

## Pré-condições
- Evento de login ou logout realizado.

## Pós-condições
- Log armazenado com usuário, data, hora, IP e resultado.

## Fluxo principal
1. O ator acessa a funcionalidade **Registrar logs de autenticação**.
