# UC036 - Visualizar indicadores operacionais

## Objetivo
Apoiar tomada de decisão com indicadores.
...
## Pós-condições
- Painel de indicadores exibido.

## Fluxo principal
1. O ator acessa a funcionalidade **Visualizar indicadores operacionais**.
